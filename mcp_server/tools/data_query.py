...
class DataQueryTools:
    ...
    def get_latest_news(
        ...
        Args:
            platforms: Platform ID list, e.g., ['coindesk', 'cointelegraph']
        ...
        Example:
            ...
            >>> result = tools.get_latest_news(platforms=['coindesk'], limit=10)
            >>> print(result['total'])
            10
        """
        try:
    ...
    def get_trending_topics(
        ...
        Note: This tool is based on the personal keywords of interest list in config/frequency_words.txt for statistics,
        rather than automatically extracting hot topics from news. This is a personally customizable keywords list,
        users can add or remove keywords of interest according to their own interests.
        ...
        Returns:
            Keyword frequency statistics dictionary, including the number of times each keyword appears in news
        ...
        Example:
            ...
            5
            >>> # Returns frequency statistics of keywords you set in frequency_words.txt
        """
        try:
            # Parameter validation
    ...
    def get_news_by_date(
        ...
        Args:
            date_query: Date query string (optional, default "today"), supports:
                - Relative dates: today, yesterday, day before yesterday, 3 days ago, yesterday, 3 days ago
        ...
        Example:
            >>> tools = DataQueryTools()
            >>> # Don't specify date, default query today
            >>> result = tools.get_news_by_date(platforms=['coindesk'], limit=20)
            >>> # Specify date
